...
// Funcție pentru a citi datele din tabelul Filiale și a le scrie într-un fișier .bak
function export_filiale() {
    // Include fișierul de configurare
    require_once "config.php";

    // Numele fișierului de import
    $filename = 'filiale_backup.bak';

    // Interogare pentru a obține toate datele din tabelul Filiale
...
// Funcție pentru a citi datele din fișierul .bak și a le adauga în tabela Filiale
function import_filiale() {
    // Include fișierul de configurare
    require_once "config.php";
...
<head>
    <meta charset="utf-8">
    <title>Manipulare filiale</title>
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Detalii despre filiale</h2>
                        <div class="user-info">
			...
			<a href="create_filiale.php" class="btn btn-success ml-2 add-fil-btn"><i class="fa fa-plus"></i> Adăugare filială nouă</a>
                    </form>
		    ...
		    try {
                            ...
                            echo '<table class="table table-bordered table-striped">';
                                echo "<thead>";
                                    echo "<tr>";
                                        ...
                                        echo "<th>Poștă electronică</th>";
					echo "<th>Numărul angajaților</th>";
					echo "<th>Data inființării</th>";
					echo "<th>Serviciile</th>";
                                    echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
					...
					echo "<td>" . $row['NrAng'] . "</td>";
					echo "<td>" . $row['DtInf'] . "</td>";
					echo "<td>" . $row['Serv'] . "</td>";
                                        echo "<td>";
                                            echo '<a href="read_filiale.php?id='. $row['id'] .'" class="mr-3" title="Vizualizare înregistrare" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                            echo '<a href="update_filiale.php?id='. $row['id'] .'" class="mr-3" title="Înnoire înregistrare" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                            echo '<a href="delete_filiale.php?id='. $row['id'] .'" title="Ștergere înregistrare" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";                            
                        ...
                        echo '<div class="alert alert-danger"><em>Erroare fatală: Tabela "Filiale" nu există în baza de date.</em></div>';
                    } catch (Exception $e) {
