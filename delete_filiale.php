...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM Filiale WHERE id = ?";
...
<head>
    <meta charset="utf-8">
    <title>Ștergerea filialei</title>
...
<body>
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Ștergerea filialei</h2>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <p>Sunteți încrezut că vreți să ștergeți înregistrarea acestei filiale?</p>
                            <p>
                                <input type="submit" value="Da" class="btn btn-danger">
                                <a href="index_filiale.php" class="btn btn-secondary">Nu</a>
                            </p>
                        </div>
                    </form>
                </div>
